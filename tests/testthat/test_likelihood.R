...
#        }
#    }
#    pruned.ll <- FinishLikelihoodCalculation(phy=phy.pruned, liks=liks, Q=expList, root.p=rep(.25,4))
...
#       }
#   }
#   indicator.ll <- FinishLikelihoodCalculation(phy=phy, liks=liks, Q=expList, root.p=rep(.25,4))
